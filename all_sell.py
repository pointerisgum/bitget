...
# # m = marketApi.market_price('SEOSSUSDT_SUMCBL')
# # marketPrice = float(m['data']['markPrice'])

# buyResult = planApi.place_plan('SEOSSUSDT_SUMCBL', marginCoin=coin, size=100, side='open_long', orderType='market',
#                 triggerPrice=2.365,
#                 executePrice=2.365,
#                 triggerType='fill_price',
#                 presetStopLossPrice=2.0)
# print(buyResult)
# print()
# # for t in tickers:
# #     test(t)
...
#                 isSell = False
#                 if nowStatus is not None and nowStatus['side'] == side:
#                     #매도 됨
#                     if position == 'long':
#                         tickerDict[t]['long'] = {}
#                     if position == 'short':
...
#         print(myAvailable)
#         print(equity)
#         total = round(equity - myAvailable, 1)
#         print('손익 : ', total)
#         if total > 50:
#             bot.sendMessage(chat_id=chatId, text=total)
#         # if total > 200:
#         #     allSell()
#         #     allCancel()
