    ...
    while True:
        ...
        if isBuy == False:
            ...
            if isDeadCross == True:
                #데드 -> 골드로 바뀐 경우
                if gold:
                    msg = 'S', 'Status Change', 'Golden Cross'
                ...
                #골드 -> 데드로 바뀐 경우
                if dead:
                    msg = 'S', 'Status Change', 'Dead Cross'
                    # bot.sendMessage(chat_id="-796323955", text=msg)      
            ...
            if isGoldenCross == False and isDeadCross == False:                
                ...
                if isGoldenCross == True:
                    if check1 == False:
                        if cci >= 110:
                            check1 = True
                            msg = 'S', 'check1 success', 'CCI:', cci
                            # bot.sendMessage(chat_id="-796323955", text=msg)
                    elif check2 == False:
                        if cci <= -110:
                            check2 = True
                            msg = 'S', 'check2 success', 'CCI:', cci
                            # bot.sendMessage(chat_id="-796323955", text=msg)
                    elif check3 == False:
                        if cci >= -95:
                            cciCheckCnt += 1
                            if cciCheckCnt >= 30:
                                ...
                                marketResult = orderApi.place_order(ticker, marginCoin='SUSDT', size=size, side='open_long', orderType='limit',
                                ...
                                msg = 'S', 'check3 success', 'CCI:', cci, 'CurrentPrice:', currentPrice
                                # bot.sendMessage(chat_id="-796323955", text=msg)
                                ...
                                while orderId > 0 and waitCnt >= 0:
                                    ...
                                    if state == 'filled':
                                        ...
                                        msg = 'S', 'Buy Long', 'CCI:', cci, 'Price:', buyPrice
                                        # bot.sendMessage(chat_id="-796323955", text=msg)                            
                                        isBuy = True
                                        trigger = planApi.place_plan(ticker, marginCoin='SUSDT', size=size, side='close_long', orderType='limit',
                                ...
                                #안사진 경우 초기화
                                if waitCnt <= 0:
                                    msg = 'S', '지정가를 도달하지 못해 구매하지 못함'
                                    # bot.sendMessage(chat_id="-796323955", text=msg)

                                    #주문 취소하기
                                    orderApi.cancel_orders(ticker, 'SUSDT', orderId)
                ...
                if isDeadCross == True:
                    if check1 == False:
                        if cci <= -110:
                            check1 = True
                            msg = 'S', 'check1Reverse success', 'CCI:', cci
                            # bot.sendMessage(chat_id="-796323955", text=msg)
                    elif check2 == False:
                        if cci >= 110:
                            check2 = True
                            msg = 'S', 'check2Reverse success', 'CCI:', cci
                            # bot.sendMessage(chat_id="-796323955", text=msg)
                    elif check3 == False:
                        if cci <= 95:
                            cciCheckCnt += 1
                            if cciCheckCnt >= 30:
                                check3 = True
                                msg = 'S', 'check3Reverse success', 'CCI:', cci
                                # bot.sendMessage(chat_id="-796323955", text=msg)
                                ...
                                #비트코인전용임
                                marketResult = orderApi.place_order(ticker, marginCoin='SUSDT', size=size, side='open_short', orderType='limit',
                                ...
                                while orderId > 0 and waitCnt >= 0:
                                    ...
                                    if state == 'filled':
                                        buyPrice = getDealPrice(ticker, orderId)    
                                        msg = 'S', 'Buy Short', 'CCI:', cci, 'Price:', buyPrice
                                        # bot.sendMessage(chat_id="-796323955", text=msg)                            
                                        isBuy = True
                                        trigger = planApi.place_plan(ticker, marginCoin='SUSDT', size=size, side='close_short', orderType='limit',
                    ...
                    if historyList is not None:
                        ...
                        if side == 'close_long':
                            ...
                            if priceAvg > 0:
                                ...
                                msg = 'S', 'Sell Long', 'Rate: ', rate
                                # bot.sendMessage(chat_id="-796323955", text=msg)

                                #트리거 취소하기
                                planApi.cancel_plan(ticker, marginCoin='SUSDT', orderId=triggerOrderId, planType='normal_plan')
                ...
                if currentPrice > maxPrice:
                    ...
                    if triggerOrderId > 0:
                        ...
                        if maxPrice > upLinePrice:
                            print('고점 갱신')
                            planApi.modify_plan(ticker, marginCoin='SUSDT', orderId=triggerOrderId, orderType='limit', 
